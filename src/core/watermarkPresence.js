const MIN_STANDARD_SPATIAL_SCORE = 0.2;
const MIN_STANDARD_GRADIENT_SCORE = 0.08;
const MIN_ADAPTIVE_CONFIDENCE = 0.35;
const MIN_ADAPTIVE_SPATIAL_SCORE = 0.3;
const MIN_ADAPTIVE_GRADIENT_SCORE = 0.08;
const MIN_ADAPTIVE_SIZE = 24;
